...
public:
    ...
    virtual void handleTouchesBegin(int num, uintptr_t ids[], float xs[], float ys[]);
    virtual void handleTouchesMove(int num, uintptr_t ids[], float xs[], float ys[]);
    virtual void handleTouchesEnd(int num, uintptr_t ids[], float xs[], float ys[]);
    virtual void handleTouchesCancel(int num, uintptr_t ids[], float xs[], float ys[]);
...
private:
    void getSetOfTouchesEndOrCancel(CCSet& set, int num, uintptr_t ids[], float xs[], float ys[]);
